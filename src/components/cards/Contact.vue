  ...
  <div class="card-inner contacts" id="contacts-card">
    <div class="card-wrap" style="">
      <div class="content contacts">
        <div class="title"><span class="first-word">Get</span> in Touch</div>
          ...
          <div class="col col-d-12 col-t-12 col-m-12 border-line-v">
            <div class="info-list">
              <ul>
                ...
                <li><strong>Remote Work . . . . .</strong> Available</li>
              </ul>
            </div>
          </div>
          <div class="clear"></div>
...
export default {
  ...
  computed: {
    phoneNumber() {
      return process.env.VUE_APP_PHONE_NUMBER
    },
    email() {
      return process.env.VUE_APP_EMAIL
    },
    city() {
      return process.env.VUE_APP_CITY
    },
    country() {
